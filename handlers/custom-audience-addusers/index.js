...
module.exports.handler = async (event, context) => {
    ...
    try {
        const newuser = await (new CustomAudience("6129734888036")).createUser(
            fields,
            params
        );
        return getResponseBody(true, "User updated in the custom audience collection.", newuser._data, 200);
    } catch (e) {
